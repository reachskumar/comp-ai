...
- ⬜ Phase 5 (Trust), Phase 6 (Self-service & Polish)
...
**What's next (Phase 4 — Prevent half, ~3-4 days):**

1. 4.3 Promotion slate equity check (auto-runs on a CompCycle's promo list)
2. 4.4 Pay band drift detector
3. 4.6 In-cycle warning at manager workspace (hooks /comp-cycles/my-team)
4. 4.7 Real-time pre-offer guardrail (when offer flow lands)
